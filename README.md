...
Current prepared version: `v1.0.18`.

## Downloads

Download native packages from the matching GitHub Release assets:

- `juhex-native-win-x64-1.0.18.zip`
- `juhex-native-macos-arm64-1.0.18.tar.gz`
- `juhex-native-macos-x64-1.0.18.tar.gz`
- `juhex-native-linux-x64-baseline-glibc-1.0.18.tar.gz`
...
Compare the output with `checksums/v1.0.18/SHA256SUMS.txt` or the `SHA256SUMS.txt` release asset.
